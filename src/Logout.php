...
<html lang="en">
    ...
    <body>
        ...
        <!--Tempory LogOut form created-->

        <form class="logout" style= "background:url(images/blackBg_Santhush.jpg); background-position: center; background-repeat: no-repeat; background-size: cover; position: relative" action="logout_process.php" method="post">
        ...
        <div class="container">
            ...
            <div class="formsubtitle" style="font-weight:200">You alread have logged into your account.<br>Click to log out from your account </div>
            
            <center>
            <div class="button">
            <input class="btn" type="submit" id="submitBtn" value="LogOut">
            <br><br><br>
            </center>
            </div>
            </div>
